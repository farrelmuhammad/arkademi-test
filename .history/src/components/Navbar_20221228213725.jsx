      ...
      <nav class="bg-white px-2 sm:px-4 py-2.5 dark:bg-blue-500 fixed w-full z-20 top-0 left-0 border-b border-blue-500 dark:border-blue-500">
        <div class="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <div class="flex gap-2 md:order-2">
            ...
            <button
              type="button"
              class="text-white bg-blue-100 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-500 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Daftar
            </button>
            <button
